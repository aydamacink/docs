...
Currently, we don't charge anything for usage or API key creation. However, it is highly recommened that you start using and updating your existing applications or new ones with your own API keys to avoid any disruption in the future.
